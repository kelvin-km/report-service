...
var public_decorator_1 = require("./decorator/public.decorator");
var AuthGuard = /** @class */ (function () {
    function AuthGuard(jwtService, reflector) {
        this.jwtService = jwtService;
        this.reflector = reflector;
    }
    AuthGuard.prototype.canActivate = function (context) {
        return __awaiter(this, void 0, void 0, function () {
            var isPublic, request, token, payload, e_1;
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.jwtService.verifyAsync(token, {
                                secret: btoa(process.env.PUBLIC_KEY)
                            })];
                    case 2:
                        payload = _a.sent();
